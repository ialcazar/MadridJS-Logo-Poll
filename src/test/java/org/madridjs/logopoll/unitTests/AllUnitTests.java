...
@RunWith(Suite.class)
@SuiteClasses({LoginControllerUnitTests.class,LogosControllerUnitTests.class,MailServiceUnitTests.class,LoginServiceUnitTests.class,UserValidatorTest.class,VotesServiceUnitTests.class})
