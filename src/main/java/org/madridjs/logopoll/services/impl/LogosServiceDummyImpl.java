...
public class LogosServiceDummyImpl implements LogosService{
	...
	public LogosRest listAllRest() {
		...
		items.add(new LogoRest(1,"Logo 2","images/logos/logo2.png"));
		items.add(new LogoRest(1,"Logo 3","images/logos/logo3.png"));
		items.add(new LogoRest(1,"Logo 4","images/logos/logo4.png"));
		items.add(new LogoRest(1,"Logo 5","images/logos/logo5.png"));
